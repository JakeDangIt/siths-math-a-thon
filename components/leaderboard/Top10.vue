        ...
        <Card>
            ...
            <CardContent class="flex flex-col">
                ...
                <div class="pt-2 lg:p-2 space-y-1">
                    <div class="flex py-2 items-center bg-slate-200 rounded-lg"
                        :class="user_id == user.uid ? 'border-slate-400 border-2' : ''"
                        v-for="(user, index) in leaderboardStore.top10.slice(3, 10)">

                        <p class="text-lg lg:text-2xl m-2 w-6 text-center">{{ index + 4 }}</p>

                        <p class="bg-slate-100 p-2 rounded-lg w-5/6 lg:w-auto">
