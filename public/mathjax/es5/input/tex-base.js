!(function () {
              ...
              (e.prototype.findMathInString = function (t, e, r) {
                ...
                for (this.start.lastIndex = 0; (n = this.start.exec(r)); ) {
                  if (void 0 !== n[this.env] && this.env) {
                    ...
                    i =
                      2 === a.length
                        ? (0, l.protoItem)('', a.substr(1), '', e, n.index, o)
                ...
                try {
                  for (var l = n(r), u = l.next(); !u.done; u = l.next()) {
                    ...
                    if (c) {
                      ...
                      d &&
                        (h
                          ? (this.Pop(), this.Push.apply(this, o([], i(h), !1)))
                          : (this.stack.push(f),
                            f.env
        ...
        var r = (function () {
          ...
          return (
            (t.processString = function (e, r) {
              for (
                var n = e.split(t.pattern), i = 1, o = n.length;
                i < o;
                i += 2
              ) {
                var a = n[i].charAt(0);
      ...
      389: function (t, e, r) {
        ...
        var R = (function (t) {
          function e(e) {
            ...
            return (
              (i.maxrow = 0),
              i.factory.configuration.tags.start(r[0], r[2], r[1]),
              i
            );
          }
          return (
      ...
      724: function (t, e, r) {
        ...
        (x.Open = function (t, e) {
          ...
          (x.Dots = function (t, e) {
            ...
            t.Push(
              t.itemFactory.create('dots').setProperties({ ldots: i, cdots: o })
            );
          }),
  ...
  !(function () {
    var t = r(723),
      ...
      O = r(724);
    MathJax.loader &&
      MathJax.loader.checkVersion('input/tex-base', e.q, 'input'),
      (0, t.r8)({
        _: {
          input: {
            tex_ts: n,
