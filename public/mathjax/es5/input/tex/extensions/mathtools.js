!(function () {
      ...
      205: function (t, e, a) {
        ...
        (e.PAIREDDELIMS = 'mathtools-paired-delims'),
          ...
          (e.MathtoolsConfiguration = l.Configuration.create('mathtools', {
            ...
            items:
              ((r = {}),
              (r[m.MultlinedItem.prototype.kind] = m.MultlinedItem),
              r),
            init: function (t) {
        ...
        e.MathtoolsMethods = {
          ...
          UnderOverBracket: function (t, e) {
            var a = (0, p.length2em)(t.GetBrackets(e, '.1em'), 0.1),
              ...
              x = t.create(
                'node',
                'mpadded',
                [t.create('node', 'mphantom', [M])],
                {
                  style: 'border: '
                    .concat(h, ' solid; border-')
                    .concat(d, ': none'),
                  height: r,
                  depth: 0,
                }
          ...
          DeclarePairedDelimiterXPP: function (t, e) {
            var a = M.default.GetCsNameArgument(t, e),
              ...
              i = t.GetArgument(e),
              s = t.GetArgument(e);
            g.MathtoolsUtil.addPairedDelims(t.configuration, a, [
              n,
              l,
              s,
              r,
          ...
          SetOptions: function (t, e) {
            ...
            try {
              for (
                var c = n(Object.keys(u)), m = c.next();
                !m.done;
                m = c.next()
              ) {
                var h = m.value;
  ...
  (t = u(955)),
    ...
    (l = u(262)),
    MathJax.loader &&
      MathJax.loader.checkVersion('[tex]/mathtools', e.q, 'tex-extension'),
    (0, t.r8)({
      _: {
        input: {
          tex: {
